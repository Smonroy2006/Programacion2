...
public class GatoDTO extends Animal implements Serializable {
	 ...
	 * @param tienePelo
	 */
	public GatoDTO(String patronPelaje, boolean tienePelo) {
		super();
	 ...
	 * @param tienePelo
	 */
	public GatoDTO(String nombre, String raza, int edad, float peso, String patronPelaje, boolean tienePelo) {
