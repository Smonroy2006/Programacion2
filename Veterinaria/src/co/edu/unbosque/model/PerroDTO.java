...
public class PerroDTO extends Animal implements Serializable {
	...
	public PerroDTO(String formaNariz) {
		super();

		this.formaNariz = formaNariz;
	}

	public PerroDTO(String nombre, String raza, int edad, float peso, String formaNariz) {
