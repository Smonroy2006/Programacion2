...
public class ReptilDTO extends Animal implements Serializable{
	...
	public ReptilDTO(boolean esVenenoso, int tiempoDeMudaDePiel) {
		super();
		this.esVenenoso = esVenenoso;
		this.tiempoDeMudaDePiel = tiempoDeMudaDePiel;
	}

	public ReptilDTO(String nombre, String raza, int edad, float peso, boolean esVenenoso, int tiempoDeMudaDePiel) {
