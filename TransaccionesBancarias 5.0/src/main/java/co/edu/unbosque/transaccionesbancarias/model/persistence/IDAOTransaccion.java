...
/**
 * Interface para los DAO del objeto Transaccion, tiene los metodos necesarios del CRUD, pero sin la logica
 * @param <T> Type, tipo de objeto, Transaccion
 * @param <K> Key, llave del objeto, String ID
 */
public interface IDAOTransaccion <T,K> {
