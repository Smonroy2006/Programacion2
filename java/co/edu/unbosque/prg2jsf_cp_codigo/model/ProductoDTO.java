...
public class ProductoDTO {
     ...
     */
    public ProductoDTO(String nombre, String ID, String categoria, String descripcion, boolean estado, double promedioCalificaciones, int cantidadComentarios, List<Calificacion> calificaciones, int calificacion, Date ultimaCalificacionFecha) {
        this.nombre = nombre;
        this.ID = ID;
