...
@Table(name="payment")
@NamedQueries(@NamedQuery(name="Payment.findAll", query="SELECT e FROM Payment e"))
@Entity
public class Payment {
     ...
     * @param numberInstallments, the number of installments that the payment have
     ...
     */
    public Payment(String code, int numberInstallments, String nameCommerce, double price, double iva, boolean status, Date date, User user, List<Installment> installments) {
        this.code = code;
